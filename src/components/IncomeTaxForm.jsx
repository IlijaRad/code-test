        ...
        <div>
          ...
          <div className="flex items-center gap-x-2">
            ...
            <select
              ...
              className="mt-3 block w-full max-w-[140px] appearance-none rounded-lg bg-white px-4 py-2.5 text-gray-900 shadow ring-1 ring-gray-900/[0.08] focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
